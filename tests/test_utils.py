...
from src.utils import create_products_by_categories, read_json
...
def test_create_products_by_categories_from_dict(products_by_category_list: dict) -> None:
    categories_list = create_products_by_categories(products_by_category_list)
